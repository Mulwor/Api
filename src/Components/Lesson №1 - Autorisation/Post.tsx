        ...
        <div>
            <div className={'form'}>
                <div className={"babel"}>
                    ...
                    <div className={'block'}>
                        <ol>
                            <li> Необходимо сделать форму, где пользователь вводит username, email и два поля для пароля.</li>
                            <li> Если пользователь в одном поле для пароля внес один пароль, во второй форме, другой пароль, то выдавать ему ошибку "пароли не совпадают"</li>
                            <li> Если пароли одинаковые, и проверка проходит, пользователь может нажать на кнопку "зарегистрироваться"</li>
                            <li> <b>Допилить:</b> Когда сервер возвращает ошибку тебе на регистрацию, покажи ее пользователю
                                 Если же бекенд вернет status  200, то покажи пользователю сообщение "вы успешно зарегистрировались" </li>
                            <li><b>Сделать:</b> Сделать авторизацию с двумя формачками: логин и пароль</li>
                        </ol>
                    </div>
                    <p className={'line'}></p>
                </div>
